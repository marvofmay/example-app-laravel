...
/***/ "./resources/js/model/product/product.js":
/*!***********************************************!*\
  !*** ./resources/js/model/product/product.js ***!
  \***********************************************/
...
var Product = /*#__PURE__*/function () {
  function Product(productId, productName, productDescription, token) {
    var _this = this;

    _classCallCheck(this, Product);

    _defineProperty(this, "deleteProduct", function () {
...
/* harmony import */ var _model_product_product_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/product/product.js */ "./resources/js/model/product/product.js");
...
$(document).ready(function () {
  ...
  $(document).on('click', '.btn-delete-product', function (e) {
    e.preventDefault();
    product = new _model_product_product_js__WEBPACK_IMPORTED_MODULE_1__["default"]($(this).data('product-id'), $(this).data('product-name'), $(this).data('product-description'), $(this).data('token'));
  ...
  var initModalConfirmDeleteProduct = function initModalConfirmDeleteProduct(product) {
    ...
    $('#modal-confirm-title-product').append(" \"".concat(product.name, "\""));
    $('#modal-confirm-body-product').html(product.description);
    $('#modal-confirm-delete-product').modal('show');
  };

  var showDeleteProductInfo = function showDeleteProductInfo(res) {
