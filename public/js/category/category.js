...
/***/ "./resources/js/model/category/category.js":
/*!*************************************************!*\
  !*** ./resources/js/model/category/category.js ***!
  \*************************************************/
...
var Category = /*#__PURE__*/function () {
  function Category(categoryId, categoryName, categoryDescription, token) {
    var _this = this;

    _classCallCheck(this, Category);

    _defineProperty(this, "deleteCategory", function () {
      var promise = new Promise(function (resolve, reject) {
        ...
        }).success(function (msgFromPHPServer) {
...
/* harmony import */ var _model_category_category_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/category/category.js */ "./resources/js/model/category/category.js");
...
$(document).ready(function () {
  ...
  $(document).on('click', '.btn-delete-category', function (e) {
    e.preventDefault();
    category = new _model_category_category_js__WEBPACK_IMPORTED_MODULE_1__["default"]($(this).data('category-id'), $(this).data('category-name'), $(this).data('category-description'), $(this).data('token'));
  ...
  var initModalConfirmDeleteCategory = function initModalConfirmDeleteCategory(category) {
